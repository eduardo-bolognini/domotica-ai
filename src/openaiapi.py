...
"""
    ...
    {"- Possible status: "+ dispositivo.stati if getattr(dispositivo, "stati", None) is not None else ""}\n\n"""
...
if __name__ == "__main__":  
    with open("config_file.json", "r") as f:
        config = json.load(f)
    API_KEY_OPENAI = config["models apy key / ids"]["openai"]
    print(recreate_confg(API_KEY_OPENAI))
